...
class Ui_SimpleObjectivesWidget(object):
    ...
    def retranslateUi(self, SimpleObjectivesWidget):
        ...
        self.talk_lbl.setText(_translate("SimpleObjectivesWidget", "Talk"))
        self.fruition_nb_lbl.setText(_translate("SimpleObjectivesWidget", "0"))
        self.exp_lbl.setText(_translate("SimpleObjectivesWidget", "Experience"))
        self.fruition_lbl.setText(_translate("SimpleObjectivesWidget", "Fruition"))
